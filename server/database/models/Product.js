...
const Product = sequelize.define('Product', {
  ...
  category: {
    ...
    validate: {
      isIn: {
        args: [['Electronics', 'Clothing', 'Books', 'Home', 'Sports', 'Food', 'Other', 'Sisteme franare', 'Consumabile', 'Sisteme luminare fata', 'Sisteme curatare parbriz', 'Baterii', 'Sisteme de parcare']],
